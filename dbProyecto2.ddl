...
ALTER TABLE catalogoMulta ADD CONSTRAINT catalogoMulta_PK PRIMARY KEY CLUSTERED (idMulta, idInfraccion)
     WITH (
     ALLOW_PAGE_LOCKS = ON , 
     ALLOW_ROW_LOCKS = ON )
GO
