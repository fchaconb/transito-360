...
namespace DataAccess.Migrations
{
    ...
    [Migration("20241103223712_AgregaInfraccionMulta")]
    partial class AgregaInfraccionMulta
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DTO.infraccionMulta", b =>
                {
                    ...
                    b.HasIndex("idMulta", "idInfraccion")
                        .IsUnique();
            ...
            modelBuilder.Entity("DTO.Disputas", b =>
                {
                    b.HasOne("DTO.Usuario", "Juez")
                        .WithMany()
                        .HasForeignKey("IdJuez")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DTO.Usuario", "UsuarioOficial")
                        .WithMany()
                        .HasForeignKey("IdOficial")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DTO.Usuario", "UsuarioFinal")
                        .WithMany()
            ...
            modelBuilder.Entity("DTO.Multas", b =>
                {
                    b.HasOne("DTO.Disputas", "Disputa")
                        .WithMany()
                        .HasForeignKey("DisputaId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("DTO.Facturas", null)
                        .WithMany("Multas")
            ...
            modelBuilder.Entity("DTO.infraccionMulta", b =>
                {
                    b.HasOne("DTO.CatalogoInfracciones", "Infraccion")
                        .WithMany()
